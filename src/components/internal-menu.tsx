  ...
  return <nav className="mt-3 overflow-x-auto pb-1" aria-label="Secciones del proyecto">
    <div className="flex min-w-max items-end gap-1 rounded-2xl border border-[#d8d1c7] bg-[#fffdf9] px-2 pt-2 shadow-sm">
      ...
      <details className="group relative ml-auto">
        <summary className={`flex cursor-pointer list-none items-center gap-1 rounded-t-xl px-3 py-2.5 text-xs font-bold transition sm:text-sm ${secondaryItems.some(([, href]) => pathname === href) ? "bg-[#254b3d] text-white" : "bg-[#d96c4a] text-white hover:bg-[#b95638]"}`}>
          Más <span className="text-base font-normal leading-none transition group-open:rotate-45">+</span>
        </summary>
        <div className="absolute right-0 z-30 mt-1 min-w-44 overflow-hidden rounded-2xl border border-[#d8d1c7] bg-[#fffdf9] p-1.5 shadow-xl shadow-[#203f34]/15">
