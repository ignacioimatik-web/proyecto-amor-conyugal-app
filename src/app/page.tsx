...
const features = [
  ...
  },
  {
    ...
    description: "Encuentra el retiro perfecto para renovar tu alianza. Fechas, lugares y facilitadores.",
    href: "/retiros",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Artículos, cursos y guías sobre comunicación, espiritualidad, sexualidad y finanzas.",
    href: "/formacion",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Adoraciones",
    description: "Momentos de oración y adoración eucarística para parejas que buscan fortalecer su fe.",
    href: "/adoraciones",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Misiones",
    description: "Conoce a las parejas misioneras que llevan el amor de Dios a los confines del mundo.",
    href: "/misiones",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
