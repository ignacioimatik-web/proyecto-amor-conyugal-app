...
export default function Home() {
  ...
  return <main className="min-h-screen bg-[#f7f3ed] text-[#24342e]">
    <section className="mx-auto max-w-6xl px-5 pb-16 pt-5 sm:px-8">
      <nav className="flex items-center justify-between py-3"><span className="rounded-full border border-[#d8d1c7] bg-white px-4 py-2 text-xs font-bold text-[#66736b]">Evangelio para matrimonios · 2026 — 2029</span><InternalMenu /></nav>
      <a href="https://proyectoamorconyugal.es/" target="_blank" rel="noreferrer" className="mt-2 block overflow-hidden rounded-[1.75rem] bg-white shadow-sm ring-1 ring-[#e4dbd0] transition hover:shadow-md" aria-label="Proyecto Amor Conyugal, web oficial"><img src="/proyecto-amor-conyugal-header.jpg" alt="Proyecto Amor Conyugal" className="block h-auto w-full" /></a>
